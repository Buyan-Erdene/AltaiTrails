class SearchForm extends HTMLElement {
    ...
    connectedCallback() {
        ...
        document.body.addEventListener('darkmode-toggle', () => this.updateDarkMode());
        this.updateDarkMode();
        

        const savedParams = localStorage.getItem('searchParams');
        if (savedParams) {
            this.setSearchParams(JSON.parse(savedParams));
        }
    }
    ...
    updateDarkMode() {
        ...
        this.shadowRoot.host.style.setProperty('--sectioncolor', isDark ? '#222' : 'white');
        this.shadowRoot.host.style.setProperty('--maincolor', '#FD9545');
        this.shadowRoot.host.style.setProperty('--darkfont', isDark ? 'white' : 'black');
    }
